...
public class TextToSQLRequest
{
    ...
    public static class Schema
    {
        ...
        public List<SchemaItem> getSchema_items()
        {
            return schema_items;
        }

        public void setSchema_items(List<SchemaItem> schema_items)
        {
            this.schema_items = schema_items;
        }

        public List<List<String>> getForeign_keys()
        {
            return foreign_keys;
        }

        public void setForeign_keys(List<List<String>> foreign_keys)
        {
            this.foreign_keys = foreign_keys;
        }
        ...
        public static class SchemaItem
        {
            ...
            public List<String> getColumn_comments()
            {
                return column_comments;
            }

            public void setColumn_comments(List<String> column_comments)
            {
                this.column_comments = column_comments;
            }

            public List<List<String>> getColumn_contents()
            {
                return column_contents;
            }

            public void setColumn_contents(List<List<String>> column_contents)
            {
                this.column_contents = column_contents;
            }

            public List<Integer> getPk_indicators()
            {
                return pk_indicators;
            }

            public void setPk_indicators(List<Integer> pk_indicators)
            {
                this.pk_indicators = pk_indicators;
            }
        }
